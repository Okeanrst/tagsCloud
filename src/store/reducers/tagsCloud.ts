...
import { BUILD_CLOUD_FAILURE, BUILD_CLOUD_REQUEST, BUILD_CLOUD_SUCCESS, RESET_TAGS_CLOUD } from '../actions/actionTypes';
...
export const tagsCloudReducer = (
  ...
  switch (action.type) {
    case BUILD_CLOUD_REQUEST:
      return { ...state, status: PENDING };
    case BUILD_CLOUD_SUCCESS:
      return { ...state, status: SUCCESS, ...action.data };
    case BUILD_CLOUD_FAILURE:
